#ifndef FLOW_LEVEL_SIM_PURE_OCS_KSP_SCHEDULER_H
#define FLOW_LEVEL_SIM_PURE_OCS_KSP_SCHEDULER_H
...
class PureOcsKspScheduler : public Scheduler {
public:
    explicit PureOcsKspScheduler(int kspK);
