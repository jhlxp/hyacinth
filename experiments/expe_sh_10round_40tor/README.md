...
- `mix/run_mix_sweep.sh`
  - Sweep `TRAFFIC_MODEL_MIX`: `3L,2M,1S`, `5L`, `10S` (40-rack baseline)
...
- 10 schedulers, parallel cap `MAX_JOBS=24` by default
...
- `experiments/expe_logs_10round/<type>/batch_<timestamp>_<type>/...`
  - `experiments/expe_logs_10round_40tor/<type>/batch_<timestamp>_<type>/...`
...
```bash
cd /home/xuheng/Desktop/ToN2026/hyacinth/experiments/expe_sh_10round_40tor
